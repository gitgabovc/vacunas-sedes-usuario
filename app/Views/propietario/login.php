<div class="signin">
    <main class="form-signin w-100 m-auto text-center">
        ...
        <form action="<?php echo base_url('check') ?>" method="POST" autocomplete="off">
            ...
            <div class="col-12 mb-1">
            <button class="w-100 btn btn-md btn-success">Iniciar Sesión</button>
            </div>
        </form>
            <div class="col-12 mb-1">
                <a class="w-100 btn btn-md btn-danger" href="<?php echo base_url('register'); ?>">Crear Usuario</a>
            </div>
        <p class="mt-5 mb-3 text-muted">&copy; SEDES-2022</p>
        <a class="w-100 btn btn-md btn-dark" href="<?php echo base_url('loginresp'); ?>">Vacunadores</a>
    </main>
</div>