...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 29-06-2022 a las 17:21:53
...
INSERT INTO `mascota` (`id`, `propietario_id`, `raza_id`, `nombre`, `sexo`, `edad`, `foto`, `color`, `tipo`, `estado`, `add_at`, `mod_at`, `del_at`) VALUES
(1, 1, 1, 'ARA', 'M', NULL, NULL, 'CAFE', 'P', '1', NULL, NULL, NULL),
(3, 2, 2, 'ADA', 'H', '1', NULL, 'NEGRO', 'G', '1', NULL, NULL, NULL);
